...
var _krisajenkins$elm_exts$Exts_List$unique = function () {
	var f = F2(
		function (x, _p0) {
			...
			var _p3 = _p1._0;
			var _p2 = _p1._1;
			return A2(_elm_lang$core$Set$member, x, _p3) ? {ctor: '_Tuple2', _0: _p3, _1: _p2} : {
				ctor: '_Tuple2',
				_0: A2(_elm_lang$core$Set$insert, x, _p3),
				_1: A2(_elm_lang$core$List_ops['::'], x, _p2)
			};
		});
	return function (_p4) {
		return _elm_lang$core$List$reverse(
...
var _krisajenkins$elm_exts$Exts_List$rest = function (_p5) {
	return A2(
...
var _krisajenkins$elm_exts$Exts_List$firstMatch = F2(
...
var _krisajenkins$elm_exts$Exts_List$maybeSingleton = function (_p8) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$Maybe$map, _krisajenkins$elm_exts$Exts_List$singleton, _p8));
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'glyphicon', _1: true},
						{
						ctor: '_Tuple2',
...
var _user$project$Tags$toSlug = _elm_lang$core$Basics$toString;
var _user$project$Tags$displayName = function (tag) {
	var _p0 = tag;
	switch (_p0.ctor) {
		case 'OpenSource':
			return 'Open Source';
...
var _user$project$Tags$InternetOfThings = {ctor: 'InternetOfThings'};
var _user$project$Tags$Fitness = {ctor: 'Fitness'};
var _user$project$Tags$Recruitment = {ctor: 'Recruitment'};
var _user$project$Tags$Retail = {ctor: 'Retail'};
var _user$project$Tags$PostgreSQL = {ctor: 'PostgreSQL'};
var _user$project$Tags$Datomic = {ctor: 'Datomic'};
var _user$project$Tags$Social = {ctor: 'Social'};
var _user$project$Tags$Haskell = {ctor: 'Haskell'};
var _user$project$Tags$Elm = {ctor: 'Elm'};
var _user$project$Tags$Clojure = {ctor: 'Clojure'};
var _user$project$Tags$ClojureScript = {ctor: 'ClojureScript'};
var _user$project$Tags$JavaScript = {ctor: 'JavaScript'};
var _user$project$Tags$technologyTags = _elm_lang$core$Native_List.fromArray(
	[_user$project$Tags$ClojureScript, _user$project$Tags$Clojure, _user$project$Tags$JavaScript, _user$project$Tags$Elm, _user$project$Tags$Haskell, _user$project$Tags$Datomic, _user$project$Tags$PostgreSQL]);
var _user$project$Tags$Backend = {ctor: 'Backend'};
var _user$project$Tags$Frontend = {ctor: 'Frontend'};
var _user$project$Tags$Client = {ctor: 'Client'};
var _user$project$Tags$OpenSource = {ctor: 'OpenSource'};
var _user$project$Tags$fromSlug = function (tag) {
	var _p1 = tag;
	switch (_p1) {
		case 'OpenSource':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$OpenSource);
		case 'Client':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$Client);
		case 'Frontend':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$Frontend);
		case 'Backend':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$Backend);
		case 'InternetOfThings':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$InternetOfThings);
		case 'ClojureScript':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$ClojureScript);
		case 'Clojure':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$Clojure);
		case 'Elm':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$Elm);
		case 'Haskell':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$Haskell);
		case 'Social':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$Social);
		case 'Fitness':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$Fitness);
		case 'Retail':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$Retail);
		case 'Recruitment':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$Recruitment);
		case 'JavaScript':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$JavaScript);
		case 'Datomic':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$Datomic);
		case 'PostgreSQL':
			return _elm_lang$core$Maybe$Just(_user$project$Tags$PostgreSQL);
		default:
			return _elm_lang$core$Maybe$Nothing;
	}
};

var _user$project$Types$Client = F7(
	function (a, b, c, d, e, f, g) {
		return {id: a, name: b, website: c, description: d, projectDetails: e, testimonial: f, tags: g};
	});
var _user$project$Types$Project = F2(
	function (a, b) {
...
var _user$project$Types$ByTag = function (a) {
	return {ctor: 'ByTag', _0: a};
};
var _user$project$Types$Home = {ctor: 'Home'};

var _user$project$Routing$toPath = function (view) {
	var _p0 = view;
	switch (_p0.ctor) {
		case 'Home':
			return _elm_lang$core$Native_List.fromArray(
		...
		case 'ByTag':
			return _elm_lang$core$Native_List.fromArray(
				[
					'tag',
					_user$project$Tags$toSlug(_p0._0)
				]);
		case 'ByClient':
			return _elm_lang$core$Native_List.fromArray(
				['client', _p0._0]);
...
var _user$project$Routing$parser = _evancz$url_parser$UrlParser$oneOf(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_evancz$url_parser$UrlParser$format,
			function (string) {
				var _p1 = _user$project$Tags$fromSlug(string);
				if (_p1.ctor === 'Just') {
					return _user$project$Types$ByTag(_p1._0);
				} else {
			...
			A2(
			_evancz$url_parser$UrlParser$format,
			_user$project$Types$ByClient,
			A2(
				_evancz$url_parser$UrlParser_ops['</>'],
				_evancz$url_parser$UrlParser$s('client'),
				_evancz$url_parser$UrlParser$string))
		]));
var _user$project$Routing$hashParser = function (hash) {
	return A2(
		...
		A3(
			...
			A2(_krisajenkins$elm_exts$Exts_String$removePrefix, '#/', hash)));
};
var _user$project$Routing$hashRouter = function (_p2) {
	return A2(
		F2(
			function (x, y) {
		...
		A2(
			_elm_lang$core$String$join,
			'/',
			_user$project$Routing$toPath(_p2)));
};

var _user$project$Clients_Drayson$projectDetails = '\nSorry, this one was confidential!\n\nThey needed something fast. We did it even faster, with Elm.\n';
var _user$project$Clients_Drayson$description = '\nFounded by Lord Drayson, Drayson Technologies is a hardware company\nbuilding products to wirelessly power the Internet of Things.\n';
var _user$project$Clients_Drayson$testimonial = _elm_lang$core$Maybe$Nothing;
var _user$project$Clients_Drayson$data = {
	id: 'drayson-technologies',
	name: 'Drayson Technologies',
	website: _elm_lang$core$Maybe$Just('http://www.draysontechnologies.com/'),
	description: _user$project$Clients_Drayson$description,
	projectDetails: _user$project$Clients_Drayson$projectDetails,
	testimonial: _user$project$Clients_Drayson$testimonial,
	tags: _elm_lang$core$Native_List.fromArray(
		[_user$project$Tags$Elm, _user$project$Tags$Frontend, _user$project$Tags$InternetOfThings])
};

var _user$project$Clients_CommercialStreet$projectDetails = '\nClearer Code is building Commercial Street\'s systems, covering a\nvariety of data-importers, a geo-aware, searchable, cross-referencing\ndatabase system, and a rich, interactive frontend.\n\nThis is an on-going project being built on the HELP stack - Haskell,\nElm, Linux & PostgreSQL.\n';
var _user$project$Clients_CommercialStreet$description = '\nCommercial Street are a startup aiming to revolutionise the commercial property market, bringing together a wide range of property datasources to give a clearer picture of the High Street.\n';
var _user$project$Clients_CommercialStreet$testimonial = _elm_lang$core$Maybe$Nothing;
var _user$project$Clients_CommercialStreet$data = {
	id: 'commercial-street',
	name: 'Commercial Street',
	website: _elm_lang$core$Maybe$Just('http://www.commercialstreet.co.uk/'),
	description: _user$project$Clients_CommercialStreet$description,
	projectDetails: _user$project$Clients_CommercialStreet$projectDetails,
	testimonial: _user$project$Clients_CommercialStreet$testimonial,
	tags: _elm_lang$core$Native_List.fromArray(
		[_user$project$Tags$Elm, _user$project$Tags$Haskell, _user$project$Tags$Frontend, _user$project$Tags$Backend, _user$project$Tags$PostgreSQL])
};

var _user$project$Clients_FunctionalWorks$projectDetails = '\nFunctional Works are a great agency - a rare thing in IT! They wanted\nto expand their service by providing an online match-making service,\nfeaturing a CV editor for prospective employees, and a\nrelationship-tracker for employers. Working with [BrightNorth] we\nbuilt their first prototype in ClojureScript & Clojure.\n\n[BrightNorth]: http://www.brightnorth.co.uk/\n';
var _user$project$Clients_FunctionalWorks$description = '\nFunctional Works are a tech recruitment agency that specialises in the growing Functional Programming market.\n';
var _user$project$Clients_FunctionalWorks$testimonial = _elm_lang$core$Maybe$Nothing;
var _user$project$Clients_FunctionalWorks$data = {
	id: 'functional-works',
	name: 'Functional Works',
	website: _elm_lang$core$Maybe$Just('http://functionalworks.com/'),
	description: _user$project$Clients_FunctionalWorks$description,
	projectDetails: _user$project$Clients_FunctionalWorks$projectDetails,
	testimonial: _user$project$Clients_FunctionalWorks$testimonial,
	tags: _elm_lang$core$Native_List.fromArray(
		[_user$project$Tags$ClojureScript, _user$project$Tags$Clojure, _user$project$Tags$Frontend, _user$project$Tags$Backend])
};

var _user$project$Clients_GrowthPoint$projectDetails = '\nGrowthPoint were looking to revamp an old ASP application, as a snappy\nsingle-page webapp with a modern design, backed by a new, faster REST\nAPI. They wanted to reduce the risk of moving into new technologies,\nso we worked with them at the start of the project, ensuring that they\nbegan with a sensible frontend architecture, with all the hard pieces\nworked out. At the end of the project they had a solid foundation and\na template to grow the full app.\n';
var _user$project$Clients_GrowthPoint$description = '\nGrowthPoint provides a suite of tools for sales and marketing teams to\ntrack their leads and improve their return the marketing budget they\nspend.\n';
var _user$project$Clients_GrowthPoint$testimonial = _elm_lang$core$Maybe$Nothing;
var _user$project$Clients_GrowthPoint$data = {
	id: 'growth-point',
	name: 'GrowthPoint',
	website: _elm_lang$core$Maybe$Just('http://growthpoint-inc.com/'),
	description: _user$project$Clients_GrowthPoint$description,
	projectDetails: _user$project$Clients_GrowthPoint$projectDetails,
	testimonial: _user$project$Clients_GrowthPoint$testimonial,
	tags: _elm_lang$core$Native_List.fromArray(
		[_user$project$Tags$Elm, _user$project$Tags$Frontend])
};

var _user$project$Clients_Fynder$projectDetails = '\nFynder is a company that happily takes advantage of cutting-edge\ntechnology. Their core system is written in Haskell & PostgreSQL, but\nthey were struggling to launch with an Angular frontend that never\nseemed to be ready.\n\nWe took over the frontend project, rewrote it ClojureScript, and got\nthe frontend development moving just as quickly as the backend could\ninnovate.\n\nAmong the features we built for them was a Google Calendar clone for\nbooking management. It explored the limits of what can be done with a\nfunctional frontend architecture, and proved a great success.\n';
var _user$project$Clients_Fynder$description = '\nFynder is a SaaS company providing Gym management software to gyms &\nfitness centres, and their customers. They make it easy to create a\nclass schedule, publish it to all their customers, and let customers\nmanage their bookings and payments.\n';
var _user$project$Clients_Fynder$testimonial = _elm_lang$core$Maybe$Nothing;
var _user$project$Clients_Fynder$data = {
	id: 'fynder',
	name: 'Fynder',
	website: _elm_lang$core$Maybe$Just('https://fynder.io/'),
	description: _user$project$Clients_Fynder$description,
	projectDetails: _user$project$Clients_Fynder$projectDetails,
	testimonial: _user$project$Clients_Fynder$testimonial,
	tags: _elm_lang$core$Native_List.fromArray(
		[_user$project$Tags$ClojureScript, _user$project$Tags$Haskell, _user$project$Tags$Fitness, _user$project$Tags$Social, _user$project$Tags$Frontend, _user$project$Tags$PostgreSQL])
};

var _user$project$Clients_HiHo$projectDetails = '\nHiHo were approaching a hard launch deadline and needed some help\nreaching it. Working with [Juxt], we helped add critical features to\ntheir Clojure & Datomic app, to get them ready to launch.\n\n[Juxt]: https://juxt.pro/\n';
var _user$project$Clients_HiHo$description = '\nHiHo lets you find plumbers, carpenters and any kind of tradesmen, get\na quote, and manage the whole project from your phone.\n';
var _user$project$Clients_HiHo$testimonial = _elm_lang$core$Maybe$Nothing;
var _user$project$Clients_HiHo$data = {
	id: 'hiho',
	name: 'HiHo',
	website: _elm_lang$core$Maybe$Just('http://www.hiho.com/'),
	description: _user$project$Clients_HiHo$description,
	projectDetails: _user$project$Clients_HiHo$projectDetails,
	testimonial: _user$project$Clients_HiHo$testimonial,
	tags: _elm_lang$core$Native_List.fromArray(
		[_user$project$Tags$Clojure, _user$project$Tags$Backend, _user$project$Tags$Datomic])
};

var _user$project$Clients_OpenSensors$projectDetails = '\nOpenSensors were struggling to get the architecture of their webapp to\nwork for them. The system they had was confusing, slow to develop, and\nbrittle.\n\nTheir backend was in Clojure so, we worked with them to do a complete\noverhaul of the frontend in ClojureScript, putting in a reactive\narchitecture with a clearer control flow and a strong focus on data\nmodelling.\n\nWe are now helping them build a second, end-user facing site in Elm.\n';
var _user$project$Clients_OpenSensors$description = '\nOpenSensors are a real-time data platform for smart devices. They\nmake it easy for businesses and consumers to gather, process and\ndisplay data from any internet-connected device.\n';
var _user$project$Clients_OpenSensors$testimonial = _elm_lang$core$Maybe$Nothing;
var _user$project$Clients_OpenSensors$data = {
	id: 'open-sensors',
	name: 'OpenSensors',
	website: _elm_lang$core$Maybe$Just('https://www.opensensors.io/'),
	description: _user$project$Clients_OpenSensors$description,
	projectDetails: _user$project$Clients_OpenSensors$projectDetails,
	testimonial: _user$project$Clients_OpenSensors$testimonial,
	tags: _elm_lang$core$Native_List.fromArray(
		[_user$project$Tags$InternetOfThings, _user$project$Tags$ClojureScript, _user$project$Tags$Frontend, _user$project$Tags$Elm])
};

var _user$project$Clients_SocialSuperstore$projectDetails = '\nSocialSuperstore had outsourced their initial prototype. Nearing\nlaunch, they wanted to bring development in-house, and we joined them\nto continue development while they built their team.\n\nThe project was a ClojureScript/Clojure/PostgreSQL stack that gave\nend-users a store editor, access to the vast catalogs of 3rd-party\nretailers, and integrated into their payments & commissions systems.\n';
var _user$project$Clients_SocialSuperstore$description = '\nSocial Superstore is building a social shopping space where users can\neasily build their own branded store curated from dozens of online\nretailers. The user takes care of marketing, and SocialSuperstore\nensure they get a cut of every sale made.\n';
var _user$project$Clients_SocialSuperstore$testimonial = _elm_lang$core$Maybe$Nothing;
var _user$project$Clients_SocialSuperstore$data = {
	id: 'social-superstore',
	name: 'Social Superstore',
	website: _elm_lang$core$Maybe$Just('https://socialsuperstore.com/'),
	description: _user$project$Clients_SocialSuperstore$description,
	projectDetails: _user$project$Clients_SocialSuperstore$projectDetails,
	testimonial: _user$project$Clients_SocialSuperstore$testimonial,
	tags: _elm_lang$core$Native_List.fromArray(
		[_user$project$Tags$Social, _user$project$Tags$Retail, _user$project$Tags$Clojure, _user$project$Tags$ClojureScript, _user$project$Tags$Frontend, _user$project$Tags$Backend])
};

var _user$project$Clients_Starlit$projectDetails = '\nStarlit\'s core product was a successful PHP that had become\nunmaintainable. Adding features and fixing bugs had become too painful\nto contemplate, so they because an overhaul. They decided to\nre-architect with an Elixir/Elm stack, and we took on the frontend Elm\ndevelopment. This project is ongoing, but so far is a great success!\n';
var _user$project$Clients_Starlit$description = '\nStarlit software are a white-label account management company for the\nretail oil & gas industry. They make it easy for consumer energy\ncompanies in the US to provide online & mobile statements & payments\nto their customers.\n';
var _user$project$Clients_Starlit$testimonial = _elm_lang$core$Maybe$Just('\nI am so, so glad we are rebuilding this application, and so glad you\'re doing it.\nI don’t know Elm, but even I can understand what the code is doing!\n\n[It\'s] a thing of beauty that I would pay for, even if it didn’t make us a dime.\n');
var _user$project$Clients_Starlit$data = {
	id: 'starlit-software',
	name: 'Starlit Software',
	website: _elm_lang$core$Maybe$Nothing,
	description: _user$project$Clients_Starlit$description,
	projectDetails: _user$project$Clients_Starlit$projectDetails,
	testimonial: _user$project$Clients_Starlit$testimonial,
	tags: _elm_lang$core$Native_List.fromArray(
		[_user$project$Tags$Elm, _user$project$Tags$Frontend])
};

var _user$project$Clients$data = _elm_lang$core$Native_List.fromArray(
	[_user$project$Clients_OpenSensors$data, _user$project$Clients_CommercialStreet$data, _user$project$Clients_Starlit$data, _user$project$Clients_HiHo$data, _user$project$Clients_SocialSuperstore$data, _user$project$Clients_Drayson$data, _user$project$Clients_FunctionalWorks$data, _user$project$Clients_Fynder$data, _user$project$Clients_GrowthPoint$data]);

var _user$project$Projects$data = _elm_lang$core$Native_List.fromArray(
	[
...
var _user$project$View_Navigation$standardFooter = A2(
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('navbar-text navbar-right')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('© 2016 Clearer Code Limited.')
										]))
								]))
						]))
				]))
		]));
var _user$project$View_Navigation$standardHeader = function (router) {
	return A2(
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												router(_user$project$Types$Home))
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('Clearer Code')
											]))
									]))
							]))
					]))
...
var _user$project$View_About$root = A2(
	_evancz$elm_markdown$Markdown$toHtml,
	_elm_lang$core$Native_List.fromArray(
		[]),
	'\n# About Us\n\nClearer Code is a software development agency specialising in Functional Programming.\n');
...
var _user$project$View$tagSet = F2(
	function (router, tags) {
		var tagView = function (tag) {
			return A2(
				_elm_lang$html$Html$span,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('label label-info label-xs tag')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_user$project$Tags$displayName(tag))
					]));
		};
		return A2(
			_elm_lang$html$Html$div,
			...
			A2(
				_elm_lang$core$List$map,
				tagView,
				A2(_elm_lang$core$List$sortBy, _elm_lang$core$Basics$toString, tags)));
	});
var _user$project$View$clientDetailView = F2(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('text-primary')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							function () {
							var _p0 = client.website;
							if (_p0.ctor === 'Nothing') {
								return _elm_lang$html$Html$text(client.name);
							} else {
								return A2(
									_elm_lang$html$Html$a,
									_elm_lang$core$Native_List.fromArray(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text(client.name)
										]));
							}
						}()
						])),
					A2(
					_user$project$View$tagSet,
					function (_p1) {
						return router(
							_user$project$Types$ByTag(_p1));
					},
					client.tags),
					A2(
						...
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('They say...')
										])),
									A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Who are they?')
						])),
					A2(
					_evancz$elm_markdown$Markdown$toHtml,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('What did we do for them?')
						])),
					A2(
					_evancz$elm_markdown$Markdown$toHtml,
					_elm_lang$core$Native_List.fromArray(
...
var _user$project$View$detailView = F3(
	function (router, view, clients) {
		detailView:
		while (true) {
			var _p3 = view;
			switch (_p3.ctor) {
				case 'NotFound':
					return _elm_lang$html$Html$text('Sorry, that page is not found.');
				case 'Home':
					return _user$project$View_About$root;
				case 'ByClient':
					var _p5 = A2(
					...
					if (_p5.ctor === 'Nothing') {
						var _v4 = router,
							_v5 = _user$project$Types$NotFound,
							_v6 = clients;
						router = _v4;
						view = _v5;
						clients = _v6;
						...
						return A2(_user$project$View$clientDetailView, router, _p5._0);
					}
				default:
					return A2(_user$project$View$tagDetailView, router, _p3._0);
			}
		}
	});
var _user$project$View$tagListGroupItem = F3(
	function (router, currentView, tag) {
		return A2(
			_elm_lang$html$Html$a,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$href(
					router(
						_user$project$Types$ByTag(tag))),
					_elm_lang$html$Html_Attributes$classList(
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'list-group-item', _1: true},
							{
							ctor: '_Tuple2',
							_0: 'active',
...
var _user$project$View$tagListGroup = F3(
	function (router, currentView, tags) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			A2(
				_elm_lang$core$List$map,
				A2(_user$project$View$tagListGroupItem, router, currentView),
				A2(_elm_lang$core$List$sortBy, _elm_lang$core$Basics$toString, tags)));
	});
var _user$project$View$projectListGroupItem = function (project) {
	return A2(
		_elm_lang$html$Html$a,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$href(project.website),
				_elm_lang$html$Html_Attributes$classList(
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'list-group-item', _1: true}
...
var _user$project$View$projectListGroup = function (projects) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		A2(_elm_lang$core$List$map, _user$project$View$projectListGroupItem, projects));
};
var _user$project$View$clientListGroupItem = F3(
	function (router, currentView, client) {
		return A2(
			_elm_lang$html$Html$a,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$href(
					router(
						_user$project$Types$ByClient(client.id))),
					_elm_lang$html$Html_Attributes$classList(
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'list-group-item', _1: true},
...
var _user$project$View$clientListGroup = F3(
	function (router, currentView, clients) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			A2(
				_elm_lang$core$List$map,
				A2(_user$project$View$clientListGroupItem, router, currentView),
				clients));
	});
var _user$project$View$strapline = '\nWe build better software with functional programming languages and the ruthless\nrefactoring that leads to clearer code.\n';
var _user$project$View$root = F2(
	function (router, model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$id('page')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$id('mainContent')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('brand')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
										...
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													...
													_elm_lang$core$Native_List.fromArray(
														[
															_elm_lang$html$Html_Attributes$class('col-xs-12 col-sm-6')
														]),
													_elm_lang$core$Native_List.fromArray(
														[
															A2(
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	...
																	_elm_lang$core$Native_List.fromArray(
																		[
																			_elm_lang$html$Html$text(_user$project$View$strapline)
																		]))
																]))
														]))
												]))
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html_Attributes$class('col-xs-12 col-sm-4 col-md-3')
												]),
											_elm_lang$core$Native_List.fromArray(
												[
													A2(
													...
													_elm_lang$core$Native_List.fromArray(
														[
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html$text('Our clients')
																])),
															A3(_user$project$View$clientListGroup, router, model.view, model.clients)
														])),
													A2(
													_elm_lang$html$Html$div,
													_elm_lang$core$Native_List.fromArray(
													...
													_elm_lang$core$Native_List.fromArray(
														[
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html$text('Other projects')
																])),
															_user$project$View$projectListGroup(model.projects)
														]))
												])),
											A2(
											_elm_lang$html$Html$div,
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html_Attributes$id('mainContent'),
													_elm_lang$html$Html_Attributes$class('col-xs-12 col-sm-8 col-md-9')
												]),
											_elm_lang$core$Native_List.fromArray(
												[
													A3(_user$project$View$detailView, router, model.view, model.clients)
												]))
										]))
								]))
						])),
					_user$project$View_Navigation$standardFooter
				]));
	});
...
var _user$project$App$main = {
	main: A2(
		...
		_elm_lang$navigation$Navigation$makeParser(
			function (_p0) {
				return _user$project$Routing$hashParser(
					function (_) {
						return _.hash;
					}(_p0));
			}),
		{
			init: _user$project$State$initialState,
			subscriptions: _user$project$State$subscriptions,
			update: _user$project$State$update,
			urlUpdate: _user$project$State$urlUpdate,
			view: _user$project$View$root(_user$project$Routing$hashRouter)
		})
};
